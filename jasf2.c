...
// SCODE_REPEAT_LT_B | SCODE_REPEAT_LT_B | SCODE_REPEAT_LT_B | SCODE_REPEAT_LT_B | SCODE_REPEAT_LT  (últimos 4 bits)
// quanto mais SCODE_REPEAT_LT* aparecerem, mais vai dando << 8 | this  até quando aparecer a primeira coisa qu e não seja repeat
//   resumindo SCODE_REPEAT_LT vira SCODE_REPEAT_LT_1 X
